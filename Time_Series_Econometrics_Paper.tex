...
20 & 34.7600 & 0.0214 & Marginal rejection & (expected for irregular cycles) \\
\bottomrule
\end{tabular}
\end{table}

The failure to reject the null at lag 10 confirms there is no significant short-term structure remaining in the residuals. The marginal rejection at lag 20 is mathematically expected; biological predator-prey cycles are inherently irregular (varying organically between 8 and 12 years), meaning some long-term cyclical echoes will naturally survive the linear ARMA parameterization.
...
\begin{enumerate}
  ...
  \item \textbf{ARMA(2,1) is the preferred model.} Across six ARMA candidates fitted
        ...
        lag~10 (Ljung--Box $p = 0.0705$), with expected long-run marginal rejection at lag 20 due to biological irregularity.
