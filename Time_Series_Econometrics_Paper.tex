...
\subsection{OLS trend regression}
\label{sec:ols}
...
\subsection{GLS with AR(1) errors}
\label{sec:gls}
...
\subsection{Preferred model: ARMA(2,1)}
\label{sec:arma21}
...
\midrule
$\hat{\sigma}^2$ & \multicolumn{2}{l}{0.2721} & \\
AIC              & \multicolumn{2}{l}{188.857} & \\
\bottomrule
\end{tabular}
\end{table}
